	...
	class Agl {
		...
		parseAddress({address}){
			...
			return (new Promise(resolve => {
				...
				const regDistrict = new RegExp("(район|округ|территория|улус)|(?:(?:[\\s\\.\\,])(р-н)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(окр)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(у)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(тер)(?:[\\s\\.\\,]))", "i");
				...
				+ "сельский\\s+совет|сомон|волость|дачный\\s+поселковый\\s+совет|городской\\s+округ|посёлок\\s+сельского\\s+типа|поселок\\s+сельского\\s+типа|"
