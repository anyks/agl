	...
	class Agl {
		...
		parseAddress({address}){
			...
			return (new Promise(resolve => {
				...
				const regDistrict = new RegExp("(район|округ|улус)|(?:(?:[\\s\\.\\,])(р-н)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(окр)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(у)(?:[\\s\\.\\,]))", "i");
				...
				+ "пос[её]лок|территория|поселение|хозяйство|товарищество|зимовье|район|город|кишлак|поссовет|сельсовет|сомон|волость|село|местечко|"
