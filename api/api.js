	...
	class Agl {
		...
		parseAddress({address}){
			...
			return (new Promise(resolve => {
				...
				const regCity = new RegExp("(район|город|пос[её]лок\\s+городского\\s+типа|рабочий\\s+пос[её]лок|курортный\\s+пос[её]лок|"
				+ "кишлак|поселковый\\s+совет|поссовет|сельсовет|сельский\\s+совет|сомон|волость|дачный\\s+поселковый\\s+совет|городской\\s+округ|"
				+ "пос[её]лок\\s+сельского\\s+типа|насел[её]нный\\s+пункт|пос[её]лок\\s+при\\s+станции|железнодорожная\\s+станция|"
				+ "сельское\\s+поселение|село|местечко|деревня|слобода|станция|хутор|разъезд|колхоз|коллективное\\s+хозяйство|зимовье|"
				+ "садовое\\s+некоммерческое\\s+товарищество|советское\\s+хозяйство|хозяйство|товарищество|поселение\\s+городского\\s+типа|"
				+ "поселение|дачный\\s+пос[её]лок|пос[её]лок)|(?:(?:[\\s\\.\\,])(пс)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(сс)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(смн)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(р-н)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(г)(?:[\\s\\.\\,])|(п\\.г\\.т\\.)|"
				+ "(?:[\\s\\.\\,])(пгт)(?:[\\s\\.\\,])|(р\\.п\\.)|(?:[\\s\\.\\,])(рп)(?:[\\s\\.\\,])|(к\\.п\\.)|(?:[\\s\\.\\,])(кп)|"
				+ "(?:[\\s\\.\\,])(к)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(вл)(?:[\\s\\.\\,])|(д\\.п\\.)|(?:[\\s\\.\\,])(п)(?:[\\s\\.\\,])|"
				+ "(н\\.п\\.)|(?:[\\s\\.\\,])(нп)(?:[\\s\\.\\,])|(п\\.\\s+ст\\.)|(п\\.ст\\.)|(?:[\\s\\.\\,])(пст)(?:[\\s\\.\\,])|"
				+ "(ж\\/д\\.\\s+ст\\.)|(ж\\/д\\s+ст\\.)|(?:[\\s\\.\\,])(с\\/п)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ж\\/дст)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(с)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(м)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(д)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(хз)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(сл)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ст)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ст-ца)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(х)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(рзд)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(клх)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(свх)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(зим)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(дп)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(тов)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пос)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пос-к)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(с\\/с)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(с-т)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(св-т)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(свт)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(св)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(го)(?:[\\s\\.\\,]))", "i");
				// Карта объектов
				const mapSubjects = {
					"р":		"Река",
					"стр":		"Страна",
