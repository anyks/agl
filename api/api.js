	...
	class Agl {
		...
		parseAddress({address}){
			...
			return (new Promise(resolve => {
				...
				const regRiver = /(река|(?:^|\s)р\.)/i;
				// Регулярное выражение для поиска домов
				const regHouse = /(дом)|(?:(?:[\s\.\,])(д)(?:[\s\.\,]))/i;
				// Регулярное выражение для поиска стран
				const regCountry = /(страна)|(?:(?:[\s\.\,])(стр)(?:[\s\.\,])|(?:[\s\.\,])(ст)(?:[\s\.\,]))/i;
				// Регулярное выражение для поиска квартир
				const regApartment = /(квартира|офис|комната)|(?:(?:[\s\.\,])(кв)(?:[\s\.\,])|(?:[\s\.\,])(ком)(?:[\s\.\,])|(?:[\s\.\,])(оф)(?:[\s\.\,]))/i;
				// Регулярное выражение для поиска микрорайонов
				const regCommunity = /(микрорайон|жилой\s+комплекс)|(?:(?:[\s\.\,])(мкр)(?:[\s\.\,])|(?:[\s\.\,])(жк)(?:[\s\.\,])|(?:[\s\.\,])(жкс)(?:[\s\.\,]))/i;
				// Регулярное выражение для поиска районов
				const regDistrict = /(район|округ|территория|улус)|(?:(?:[\s\.\,])(р-н)(?:[\s\.\,])|(?:[\s\.\,])(окр)(?:[\s\.\,])|(?:[\s\.\,])(у)(?:[\s\.\,])|(?:[\s\.\,])(тер)(?:[\s\.\,]))/i;
				// Регулярное выражение для поиска регионов
				const regRegion = new RegExp("(область|край|республика|автономный\\s+округ)|(?:(?:[\\s\\.\\,])(респ)(?:[\\s\\.\\,])"
				+ "|(?:[\\s\\.\\,])(обл)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(кр)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(рес)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(ао)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(аок)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(аокр)(?:[\\s\\.\\,]))", "i");
				// Регулярное выражение для поиска улицы
				const regStreet = new RegExp("(улица|площадь|тупик|переулок|канал|шоссе|проезд|набережная|километр|вал|бульвар|квартал|"
				+ "проспект|авеню|аллея|кольцо)|(?:(?:[\\s\\.\\,])(ул)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пл)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(пр)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пр-т)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ав)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(ал)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(алл)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(б-р)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(бр)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(вл)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(кнл)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(кв-л)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(км)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(кл)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(клц)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(наб)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(нб)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(пер)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пр-кт)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пр-зд)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(туп)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ш)(?:[\\s\\.\\,]))", "i");
				// Регулярное выражение для поиска города
				const regCity = new RegExp("(район|город|посёлок\\s+городского\\s+типа|поселок\\s+городского\\s+типа|рабочий\\s+посёлок|"
				+ "рабочий\\s+поселок|курортный\\s+посёлок|курортный\\s+поселок|кишлак|поселковый\\s+совет|поссовет|сельсовет|"
				+ "сельский\\s+совет|сомон|волость|дачный\\s+поселковый\\s+совет|посёлок\\s+сельского\\s+типа|поселок\\s+сельского\\s+типа|"
				+ "населённый\\s+пункт|посёлок\\s+при\\s+станции|железнодорожная\\s+станция|сельское\\s+поселение|село|местечко|деревня|"
				+ "слобода|станция|хутор|разъезд|колхоз|коллективное\\s+хозяйство|садовое\\s+некоммерческое\\s+товарищество|советское\\s+хозяйство|"
				+ "зимовье|посёлок|товарищество|поселение\\s+городского\\s+типа|поселение|дачный\\s+поселок|дачный\\s+посёлок|населенный\\s+пункт|"
				+ "поселок)|(?:(?:[\\s\\.\\,])(пс)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(сс)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(смн)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(р-н)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(г)(?:[\\s\\.\\,])|(п\\.г\\.т\\.)|(?:[\\s\\.\\,])(пгт)(?:[\\s\\.\\,])|"
				+ "(р\\.п\\.)|(?:[\\s\\.\\,])(рп)(?:[\\s\\.\\,])|(к\\.п\\.)|(?:[\\s\\.\\,])(кп)|(?:[\\s\\.\\,])(к)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(вл)(?:[\\s\\.\\,])|(д\\.п\\.)|(?:[\\s\\.\\,])(п)(?:[\\s\\.\\,])|(н\\.п\\.)|(?:[\\s\\.\\,])(нп)(?:[\\s\\.\\,])|"
				+ "(п\\.\\s+ст\\.)|(п\\.ст\\.)|(?:[\\s\\.\\,])(пст)(?:[\\s\\.\\,])|(ж\\/д\\.\\s+ст\\.)|(ж\\/д\\s+ст\\.)|"
				+ "(?:[\\s\\.\\,])(с\\/п)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ж\\/дст)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(с)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(м)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(д)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(сл)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(ст)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ст-ца)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(х)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(рзд)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(клх)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(свх)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(зим)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(дп)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(тов)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(пос)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пос-к)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(с\\/с)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(с-т)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(св-т)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(свт)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(св)(?:[\\s\\.\\,]))", "i");
				// Карта объектов
				const mapSubjects = {
					"р":		"Река",
				...
				const getHouse = () => {
					...
					const searchHouse = () => {
						...
						// Дома второй вариант
						const regH2 = /(?:\d+\s*\/\s*\d+)|(?:(?:\d+)\s*(?:к|с)?\s*(?:\d+)?\s*(?:к|с)?\s*(?:\d+)?)/i;
						// Объект с данными
						let house = false;
						// Ищем адрес
						arr.forEach((val, i) => {
