	...
	class Agl {
		...
		parseAddress({address}){
			...
			return (new Promise(resolve => {
				...
				+ "сельское\\s+поселение|село|местечко|деревня|слобода|станция|хутор|разъезд|колхоз|коллективное\\s+хозяйство|"
				+ "садовое\\s+некоммерческое\\s+товарищество|советское\\s+хозяйство|зимовье|товарищество|поселение\\s+городского\\s+типа|"
