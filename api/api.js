	...
	class Agl {
		...
		parseAddress({address}){
			...
			return (new Promise(resolve => {
				...
				+ "поселок)|(?:(?:[\\s\\.\\,])(пс)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(cc)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(смн)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(р-н)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(г)(?:[\\s\\.\\,])|(п\\.г\\.т\\.)|(?:[\\s\\.\\,])(пгт)(?:[\\s\\.\\,])|"
				+ "(р\\.п\\.)|(?:[\\s\\.\\,])(рп)(?:[\\s\\.\\,])|(к\\.п\\.)|(?:[\\s\\.\\,])(кп)|(?:[\\s\\.\\,])(к)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(пс)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(сс)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(вл)(?:[\\s\\.\\,])|(д\\.п\\.)|"
				+ "(?:[\\s\\.\\,])(п)(?:[\\s\\.\\,])|(н\\.п\\.)|(?:[\\s\\.\\,])(нп)(?:[\\s\\.\\,])|(п\\.\\s+ст\\.)|(п\\.ст\\.)|"
				+ "(?:[\\s\\.\\,])(пст)(?:[\\s\\.\\,])|(ж\\/д\\.\\s+ст\\.)|(ж\\/д\\s+ст\\.)|(?:[\\s\\.\\,])(с\\/п)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(ж\\/дст)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(с)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(м)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(д)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(сл)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(ст)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(ст-ца)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(х)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(рзд)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(клх)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(свх)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(зим)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(дп)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(тов)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(пос)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(пос-к)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(с\\/с)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(с-т)(?:[\\s\\.\\,])|"
				+ "(?:[\\s\\.\\,])(св-т)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(свт)(?:[\\s\\.\\,])|(?:[\\s\\.\\,])(св)(?:[\\s\\.\\,]))", "i");
				// Карта объектов
				const mapSubjects = {
					"р":		"Река",
					"стр":		"Страна",
