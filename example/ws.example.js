...
//
// socket.send(JSON.stringify({"action": "getCountryById", "query": {"id": 7}}));
// socket.send(JSON.stringify({"action": "getRegionById", "query": {"id": '3700000000000'}}));
...
// socket.send(JSON.stringify({"action": "getMetroStationById", "query": {"id": '966c4073e8d794620124a05c'}}));
...
//
// socket.send(JSON.stringify({"action": "getCountryByGPS", "query": {"lat":"55.870031", "lng":"41.772074"}}));
